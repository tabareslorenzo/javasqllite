...
b. I created the project in Eclipse. The project is in the eclipse-workspace directory. I used java 11 for this project. For the project to work sqllite jar file must be added to the eclipse project's external jar files. The logger and bad csv file are outputed into the resources folder.
